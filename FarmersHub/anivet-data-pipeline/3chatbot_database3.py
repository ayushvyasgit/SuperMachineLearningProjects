...
MONGO_URI = os.getenv("MONGO_URI", "mongodb+srv://ayushvyas99199:qegXvJWDh8bkgI1Q@a1.mihxsrj.mongodb.net/")
INPUT_CSV = os.getenv("INPUT_CSV", "farmer_medicine_finder.csv")
...
def main():
    ...
    metadata_path = Path('./embedding_metadata.json')

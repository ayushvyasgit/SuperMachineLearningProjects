...
import { getRecommendations as getBackendRecommendations, getAllMovies, checkApiHealth, Movie, MovieRecommendation } from "@/api/recommendations";
    ...
    <div className="relative h-screen overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col">
        ...
        <main className="flex-1 flex flex-col items-center px-4 overflow-hidden">
          ...
          <div className="flex-1 w-full max-w-6xl mx-auto flex items-center justify-center min-h-0">
